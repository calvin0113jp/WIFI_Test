...
#History Modify IGMPv3_Config IGMPv3 to MLDv2
...
class IGMPv3_Config(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        board.expect_exact("mcproxy.config.protocol='MLDv2'", timeout=5)
        ...
        board.expect('protocol MLDv2;', timeout=5)
        board.expect('pinstance mcproxy1: "eth3" ==> "br-lan";')
        board.expect(prompt)
