...
class Sample_Security_HttpLogin_Check(rootfs_boot.RootFSBootTest):
...
class Sample_Security_HttpLogin_Check_1(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        if 'Pass' in ping_dut_result:
            ...
            if 'Router' in dut_model or 'DAP' in dut_model or 'EAP' in dut_model:
                ...
                http_check = Sample_Security_HttpLogin_Check(None)
                http_check.runTest()
...
class Sample_Security_Nmap_TCPSyn_Scan(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0003'''
...
class Sample_Security_Nmap_TCPSyn_Scan_WAN(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0003'''
    ...
    def runTest(self):
        ...
        if 'Pass' in ping_dut_result:
            #Load TCPSyn
            dut_ip = dut_wan_ip
            TCPsyn = Sample_Security_Nmap_TCPSyn_Scan(None)
...
class Sample_Security_Nmap_TCPFin_Scan(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0008'''
...
class Sample_Security_Nmap_TCPFin_Scan_WAN(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0008'''
    ...
    def runTest(self):
        ...
        if 'Pass' in ping_dut_result:
            #Load TCPFin
            dut_ip = dut_wan_ip
            TCPFin = Sample_Security_Nmap_TCPFin_Scan(None)
...
class Sample_Security_Nmap_UDP_Scan(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0007'''
...
class Sample_Security_Nmap_UDP_Scan_WAN(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0007'''
    ...
    def runTest(self):       
        ...
        if 'Pass' in ping_dut_result:
            #Load UDP Scan
            dut_ip = dut_wan_ip
            UDPscan = Sample_Security_Nmap_UDP_Scan(None)
...
class Sample_Security_SSH_Vulnetability(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0004'''
...
class Sample_Security_Web_Vulnetability(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        if 'Pass' in ping_dut_result:
            Load_container = Sample_Security_SSH_Vulnetability(None)
...
class Sample_Security_Web_Vulnetability_1(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        if 'Pass' in ping_dut_result:
            ...
            if 'Router' in dut_model or 'DAP' in dut_model or 'EAP' in dut_model:
                ...
                web_check = Sample_Security_Web_Vulnetability (None)
                web_check.runTest()
...
class Sample_Security_FwProtection_Analysis(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0013'''
...
class Sample_Security_SSLScan(rootfs_boot.RootFSBootTest):
    '''DKP1702002-0015'''
