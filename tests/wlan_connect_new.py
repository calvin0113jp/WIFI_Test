...
# History
# 2019/6/21 First release
# 2019/6/21 Add WRC-2533GST2(Station) to WIFI Testing 
# 2019/6/26 Add PingDUT / PingInternet /BrowseWebUI
# 2019/6/27 1.Add DLINK_WIFI_SmartConnect_Enable_2G / DLINK_WIFI_SmartConnect_Enable_5G
#           2.Add wifi_result
#           3.Add PingDUT_Status / PingInternet_Status / BrowseWebUI_status
# 2019/6/28 1.Add disconnect statement if station kernel panic (reboot)
# 2019/6/29 1.Add DLINK_WIFI_SmartConnect_Enable_Modify2G_AES / DLINK_WIFI_SmartConnect_Enable_Modify5G_AES
#           2.Add DLINK_WIFI_SmartConnect_Enable_Modify2G_TKIP / DLINK_WIFI_SmartConnect_Enable_Modify5G_TKIP
# 2019/7/1  1.Add Reset in DLINK_WIFI_SmartConnect_Enable_2G - calll the dlink_basic_function
#           2.Add Call the wpa2 to DLINK_GUI_Test_WIFI_WPA2
#           3.Add Result of SSID / Ch
#           4.Add DLINK_WIFI_SmartConnect_Enable_2G_None / DLINK_WIFI_SmartConnect_Enable_5G_None
#           5.Add DLINK_WIFI_SmartConnect_Disable_2G_None / DLINK_WIFI_SmartConnect_Disable_5G_None
# 2019/7/2  1.Modify def main2g / def main5g and msg / add brctl_check 
#           2.DLINK_WIFI_SmartConnect_Disable_2G_AES / DLINK_WIFI_SmartConnect_Disable_5G_AES
#           3.DLINK_WIFI_SmartConnect_Disable_2G_TKIP / DLINK_WIFI_SmartConnect_Disable_5G_TKIP
#           4.DLINK_WIFI_SmartConnect_Disable_2G_Channel
# 2019/7/3  1.Add DLINK_WIFI_SmartConnect_Disable_5G_Channel
#           2.Modify PingDUT / PingInternet if network is unreachable
#           3.Modify ipaddress statement if unable to get
# 2019/7/4  1.Modify brctl_check
#           2.Modify Ping_Internet if nothing to read     
# 2019/7/5  Add get_bit_rate
# 2019/7/8  1.Add 802.11mode
#           2.Modify get_bit_rate_2g / get_bit_rate_5g / get_channel_2g / 5g
#           3.Add DLINK_WIFI_Mode802_11bgn_2G / DLINK_WIFI_Mode802_11anac_5G
# 2019/7/9  1.Add DLINK_WIFI_Mode802_11gn_2G / DLINK_WIFI_Mode802_11n_2G
#           2.Add DLINK_WIFI_Mode802_11nac_5G / DLINK_WIFI_Mode802_11an_5G / DLINK_WIFI_Mode802_11ac_5G /
#           3.Add DLINK_WIFI_Mode802_11a_5G / DLINK_WIFI_Mode802_11n_5G
# 2019/7/10 1.Modify connection_check / Update connection_check statement
#           2.Remove Ping DUT / Ping Internet / browse Status
# 2019/7/11 1.Modify if error command in ssid_2g / ssid5g / get ipaddress /get channel2g /get channel 5g
#           2.Add DNS in def restart to improve ping internet fail
#           3.Add disconnect_2g / disconnect_5g / connection check failed - bit rate = null
# 2019/7/12 1.Modify DLINK_WIFI_Channel Test 2G / 5G Test case to the singe case
#           2.Add retry in PingDUT_Status /Browse WebUI status / PingInternet_Status 
# 2019/7/15 1.Add Reset and reconfigre in DLINK_WIFI_Mode802_11bgn_2G
#           2.Modify get_bit_rate_5g int to float 
##############################################################################################################

# 2019/8/12 Add DLINK_WIFI_Schedule_on_2G / DLINK_WIFI_Schedule_on_5G
# 2019/8/13 Add DLINK_WIFI_out_of_Schedule_2G / DLINK_WIFI_out_of_Schedule_5G
# 2019/8/14 Add 1.DLINK_WIFI_SC_Disable_Schedule_on_2G / DLINK_WIFI_SC_Disable_Schedule_on_5G
#               2.DLINK_WIFI_SC_Disable_out_of_Schedule_2G / DLINK_WIFI_SC_Disable_out_of_Schedule_5G
# 2019/8/15 Add 1.wifi_connect - ip_routing_main
#               2.Add ip_routing_main after wifi_disconnect() 
#               3.Modify BrowseWebUI if guest zone behavior is failed to access webui
#               4.DLINK_WIFI_GuestZone
#               5.DLINK_WIFI_GuestZone_None_2G / DLINK_WIFI_GuestZone_None_5G
# 2019/8/16 Add 1.DLINK_WIFI_GuestZone_Schedule_on_2G / DLINK_WIFI_GuestZone_Schedule_on_5G
#               2.DLINK_WIFI_GuestZone_out_of_Schedule_2G / DLINK_WIFI_GuestZone_out_of_Schedule_5G
#               3.DLINK_WIFI_GuestZone_InternetAccessOnly_on / DLINK_WIFI_GuestZone_InternetAccessOnly_off
# 2019/8/20 Add Return to default 802.11 mode in DLINK_WIFI_Schedule_on_2G
# 2019/8/21 Add home_network_access in DLINK_WIFI_GuestZone_5G
# 2019/8/22 Add 1.wifi.disconnect_2g / wifi.disconnect_5g  in GuestZone2G and 5G
#               2.Add firstboot in wifi_connect
#               3.Add default setting to prevent wifi loop in send_wpa2_aes
# 2019/8/28 Add firstboot of wlan in wifi schedule / 802.11 to prevent the both wifi connection
# 2019/8/28 Modify DLINK_WIFI_GuestZone_out_of_Schedule_2G of behavior - add reset
# 2019/8/30 1.Modify DLINK_WIFI_GuestZone_2G / DLINK_WIFI_GuestZone_2G of output message 
#           2.Modify DLINK_WIFI_out_of_Schedule_2G / DLINK_WIFI_out_of_Schedule_5G of output pass message
#           3.Modify WIFIChannel 2G / 5G - Add firstboot of wlan 
# 2019/11/14 Modify DLINK_WIFI_Mode802_11bgn_2G - Add DLINK_GUI_Test_SmartConnect_Disable_WIFI_SetupAES
# 2019/11/15 1.Add Reset and config for DLINK_WIFI_SmartConnect_Disable_2G_Channel1
#            2.Add Reset and config for DLINK_WIFI_SmartConnect_Disable_5G_Channel36
#            3.Modify DLINK_WIFI_SmartConnect_Disable_2G_AES to add the reset and config
#            4.Modify DLINK_WIFI_SmartConnect_Enable_Modify2G_AES to add the reset and config
#              (Remark testsuite of DLINK_WIFI_SmartConnect_Enable2G and 5G )
#
...
from dlink_basic_function import *
...
class DLINK_WIFI_ChannelList(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Enable_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G Default Check '''
    
    def runTest(self):
        #Reset the DUT first
        g = DLINK_GUI_Test_System_Reset(None)
        g.runTest()
        
        g = DLINK_GUI_Test_Disable_Mash(None)
        g.runTest()
...
class DLINK_WIFI_SmartConnect_Enable_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Enable_Modify2G_AES(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        g = DLINK_GUI_Test_WIFI_WPA2(None)
        g.runTest()
...
class DLINK_WIFI_SmartConnect_Enable_Modify5G_AES(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Enable_Modify2G_TKIP(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Enable_Modify5G_TKIP(rootfs_boot.RootFSBootTest):
...
#class DLINK_WIFI_SmartConnect_Enable_WPA3_2G(rootfs_boot.RootFSBootTest):
#    '''WIFI 2G Modify Check (WPA3) '''

#    def runTest(self):

        #Configure GUI
#        g = DLINK_GUI_Test_WIFI_WPA3(None)
#        g.runTest()
...
#        h = DLINK_WIFI_SmartConnect_Enable_Modify2G(None)
#        h.main2g()
        
#    def recover(self):
#        board.sendcontrol(']')

class DLINK_WIFI_SmartConnect_Enable_2G_None(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        #Configure GUI
        g = DLINK_GUI_Test_WIFI_None(None)
        g.runTest()
...
class DLINK_WIFI_SmartConnect_Enable_5G_None(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_None(rootfs_boot.RootFSBootTest):
    '''WIFI 2G Check (NONE) '''

    def runTest(self):

        #Configure GUI
        g = DLINK_GUI_Test_SmartConnect_Disable_WIFI_None(rootfs_boot.RootFSBootTest)
        g.runTest()
        ...
        h = DLINK_WIFI_SmartConnect_Enable_2G_None(None)
        h.main2g()
...
class DLINK_WIFI_SmartConnect_Disable_5G_None(rootfs_boot.RootFSBootTest):
    '''WIFI 5G Check (NONE) '''    
    ...
    def runTest(self):
        ...
        h = DLINK_WIFI_SmartConnect_Enable_5G_None(None)
        h.main5g()
...
class DLINK_WIFI_SmartConnect_Disable_2G_AES(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        h = DLINK_GUI_Test_SmartConnect_Disable_WIFI_SetupAES(None)
        h.runTest()
        ...
        h = DLINK_WIFI_SmartConnect_Enable_Modify2G_AES(None)
        h.main2g()
...
class DLINK_WIFI_SmartConnect_Disable_5G_AES(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        h = DLINK_WIFI_SmartConnect_Enable_Modify5G_AES(None)
        h.main5g()
...
class DLINK_WIFI_SmartConnect_Disable_2G_TKIP(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        h = DLINK_WIFI_SmartConnect_Enable_Modify2G_TKIP(None)
        h.main2g()
...
class DLINK_WIFI_SmartConnect_Disable_5G_TKIP(rootfs_boot.RootFSBootTest):
    '''WIFI 5G Check (WAP2-AES) '''    
    ...
    def runTest(self):
        ...
        h = DLINK_WIFI_SmartConnect_Enable_Modify5G_TKIP(None)
        h.main5g()
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel1(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        k = DLINK_GUI_Test_Disable_Mash(None)
        k.runTest()
        ...
        g = DLINK_GUI_Test_SmartConnect_Disable_WIFI_Channel_2G(None)
        g.runTest()
        time.sleep(5)
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel2(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel3(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel4(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel5(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel6(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel7(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel8(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel9(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel10(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_2G_Channel11(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel36(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):
        ...
        g = DLINK_GUI_Test_SmartConnect_Disable_WIFI_Channel_5G(None)
        g.runTest()
        time.sleep(5)
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel40(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel44(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel48(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel149(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel153(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel157(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel161(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SmartConnect_Disable_5G_Channel165(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Mode802_11bgn_2G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Mode802_11gn_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G Mode802_11gn Check '''

    def runTest(self):
        g = DLINK_GUI_Test_WIFI_Mode80211_2G(None)
        g.runTest()
        time.sleep(5)

        h = DLINK_WIFI_Mode802_11bgn_2G(None)
        h.mode_11g()
        h.mode_11n()
...
class DLINK_WIFI_Mode802_11n_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G Mode802_11gn Check '''
...
class DLINK_WIFI_Mode802_11anac_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Mode802_11nac_5G(rootfs_boot.RootFSBootTest):
    '''WIFI 5G Mode802_11nac Check '''
    
    def runTest(self):
        g = DLINK_GUI_Test_WIFI_Mode80211_5G(None)
        g.runTest()
        time.sleep(10)

        h = DLINK_WIFI_Mode802_11anac_5G(None)
        h.mode_11n()
        h.mode_11ac()
...
class DLINK_WIFI_Mode802_11an_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Mode802_11ac_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Mode802_11a_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Mode802_11n_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_Schedule_on_2G(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):   
        ...
        #Reset the DUT first
        reset = DLINK_GUI_Test_System_Reset(None)
        reset.runTest()
       
        timezone = DLINK_GUI_Test_Time_Zone(None)
        timezone.runTest()
        
        k = DLINK_GUI_Test_Disable_Mash(None)
        k.runTest()       
        
        on_schedule = DLINK_GUI_Test_WIFI_Schedule_on(None)
        on_schedule.runTest()
...
class DLINK_WIFI_Schedule_on_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_out_of_Schedule_2G(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):   
        out_schedule = DLINK_GUI_Test_WIFI_Out_Of_Schedule(None)
...
class DLINK_WIFI_out_of_Schedule_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SC_Disable_Schedule_on_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G SC Disable Check with Schedule on'''

    def runTest(self):       
        on_schedule = DLINK_GUI_Test_SC_Disable_WIFI_Schedule_on(None)
        on_schedule.runTest()
...
class DLINK_WIFI_SC_Disable_Schedule_on_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_SC_Disable_out_of_Schedule_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G SC Disable Check with out of Schedule'''
 
    def runTest(self):   
        #Clear and configure both schedule
        clear_both_schedule = DLINK_GUI_Test_SC_Disable_WIFI_Schedule_ClearBoth(None)
        clear_both_schedule.runTest()

        out_schedule = DLINK_GUI_Test_SC_Disable_WIFI_out_of_Schedule(None)
        out_schedule.runTest()
        ...
        #Connect to wifi
        connect_wifi = DLINK_WIFI_out_of_Schedule_2G(None)          
        connect_wifi.main2g()
...
class DLINK_WIFI_SC_Disable_out_of_Schedule_5G(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):                   
        ...
        #Connect to wifi
        connect_wifi = DLINK_WIFI_out_of_Schedule_5G(None)          
        connect_wifi.main5g()
...
class DLINK_WIFI_GuestZone_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G GuestZone'''
    ...
    def runTest(self):
        ...
        #Configure GuestZone
        guestzone = DLINK_GUI_Test_WIFI_GuestZone(None)
        guestzone.runTest()
...
class DLINK_WIFI_GuestZone_5G(rootfs_boot.RootFSBootTest):
    '''WIFI 5G GuestZone'''
...
class DLINK_WIFI_GuestZone_None_2G(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):        
        #Configure GuestZone
        guestzone = DLINK_GUI_Test_WIFI_GuestZone_None(None)
        guestzone.runTest()
...
class DLINK_WIFI_GuestZone_None_5G(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_GuestZone_Schedule_on_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G GuestZone with schedule on'''

    def runTest(self):     
        #Configure GuestZone Schedule on
        guestzone_schedule_on = DLINK_GUI_Test_WIFI_GuestZone_Schedule_on(None)
        ...
        guestzone = DLINK_WIFI_GuestZone_2G(None) 
        guestzone.main2g()
...
class DLINK_WIFI_GuestZone_Schedule_on_5G(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self): 
        ...
        guestzone = DLINK_WIFI_GuestZone_5G(None) 
        guestzone.main5g()
...
class DLINK_WIFI_GuestZone_out_of_Schedule_2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G GuestZone with out of schedule'''

    def runTest(self):     
        #Configure GuestZone Schedule
        #guestzone_schedule_clear = DLINK_GUI_Test_WIFI_GuestZone_Schedule_Clear(None)
        ...
        guestzone_out_of_schedule = DLINK_GUI_Test_WIFI_GuestZone_Out_Of_Schedule(None)
        ...
        guestzone = DLINK_WIFI_out_of_Schedule_2G(None) 
        guestzone.main2g()
...
class DLINK_WIFI_GuestZone_out_of_Schedule_5G(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self): 
        ...
        guestzone = DLINK_WIFI_out_of_Schedule_5G(None) 
        guestzone.main5g()
...
class DLINK_WIFI_GuestZone_InternetAccessOnly_on(rootfs_boot.RootFSBootTest):
...
class DLINK_WIFI_GuestZone_InternetAccessOnly_off(rootfs_boot.RootFSBootTest):
    ...
    def runTest(self):        
        ...
        disable_internet_access_only = DLINK_GUI_Test_WIFI_GuestZone_InternetAccessOnly(None)
...
class DLINK_WIFI_SmartConnect_Disable_WPA2_Personal2G(rootfs_boot.RootFSBootTest):
    '''WIFI 2G Check (WPA2-AES) '''
    ...
    def runTest(self):
        ...
        h = DLINK_GUI_Test_Disable_WIFI_WPA2_Personal(None)
        h.runTest()
...
class DLINK_WIFI_SmartConnect_Disable_WPA2_Personal5G(rootfs_boot.RootFSBootTest):
    '''WIFI 5G Check (WAP2-AES) '''    
